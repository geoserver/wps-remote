...
class TestComputationJobInputs(unittest.TestCase):
    ...
    def test_cmd_line_action_2_values(self):
        ...
        actions = computational_job_input_actions.ComputationalJobInputActions()
        actions.add_actions(computational_job_input_action_cmd_param.
    ...
    def test_update_json_file_action_with_int(self):
        ...
        param1 = computation_job_param.ComputationJobParam("numberOfevaluations",
                                                           "int",
                                                           "par 1",
                                                           "numberOfevaluations descr")
        inputs = computation_job_inputs.ComputationJobInputs()
        action1 = computational_job_input_action_update_json_file.ComputationalJobInputActionUpdateJSONFile(
            "numberOfevaluations", target_json_file, "['Config']['nEvaluations']", source_template_json_file)
    ...
    def test_update_json_file_action_with_string(self):
        ...
        inputs = computation_job_inputs.ComputationJobInputs()
        action1 = computational_job_input_action_update_json_file.ComputationalJobInputActionUpdateJSONFile(
            "path_file_name", target_json_file, "['Config']['pathFilename']", source_template_json_file)
...
template = value'''
        ...
        inputs = computation_job_inputs.ComputationJobInputs.create_from_config(
            {'Input1': config.items('Input1'), 'Const1': config.items('Const1')})
        actions = computational_job_input_actions.ComputationalJobInputActions.create_from_config(
            {'Action1': config.items('Action1'), 'Action2': config.items('Action2')})
...
'''
        ...
        inputs = computation_job_inputs.ComputationJobInputs.create_from_config(
            {'Input2': config.items('Input2'), 'Input1': config.items('Input1')})
        actions = computational_job_input_actions.ComputationalJobInputActions.create_from_config(
            {'Action2': config.items('Action2'), 'Action1': config.items('Action1')})
    ...
    def test_update_json_list_in_file(self):
        ...
        inputs = computation_job_inputs.ComputationJobInputs()
        action1 = computational_job_input_action_update_json_file.ComputationalJobInputActionUpdateJSONFile(
            "maxlat", target_json_file, "['Config']['latLim'][1]", source_template_json_file)
    ...
    def test_update_json_list_in_file_two_times(self):
        ...
        action1 = computational_job_input_action_update_json_file.ComputationalJobInputActionUpdateJSONFile(
            "minlat", target_json_file, "['Config']['latLim'][0]", source_template_json_file)
