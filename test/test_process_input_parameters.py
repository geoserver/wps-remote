...
class TestProcessInputParameters(unittest.TestCase):
    ...
    def test_parse_float_par_with_alias(self):
        paramsDef = [('argx', {"type": "float", "description": "descr of argx",
                               "max": 1, "template": "--name=value", "alias": "arg_alias"})]
    ...
    def test_parse_const_cmdline_par(self):
        paramsDef = [('argx',
                      {"type": "string",
                       "description": "descr of argx",
                       "max": 1,
                       "template": "value",
                       "value": "this should be used",
                       "class": "wpsremote.command_line_parameter.CommandLineParameterConst"})]
