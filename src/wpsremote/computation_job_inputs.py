...
class ComputationJobInputs(object):
    ...
    def create_from_config(input_sections):
        '''Static constructor:
        create a ComputationJobInputs object from a input_sections: a dictionary such as
            { input1 : [( 'par1_input1_name' , par1_input1_value ), ( 'par2_input1_name' , par2_input1_value ), ...],
              input2 : [ .... ], ... }
        '''
    ...
    def create_from_dict(paremeters_types_defs):
        '''Static constructor:
        create a ComputationJobInputs object from paremeters_types_defs:
            {par1_name : { 'par1_attrubute1_name' : par1_attrubute1_value, ... },
             par2_name : { 'par2_attrubute1_name' : par2_attrubute1_value, ... }, ... }
        '''
    ...
    def as_DLR_protocol(self):
        ...
        for k in self._inputs.keys():
            if isinstance(self._inputs[k], computation_job_const.ComputationJobConst):
                continue
